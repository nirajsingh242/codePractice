...
class MapMethodCallCount<K, V> implements Map<K, V> {
	...
	public String toString() {
		return "MapMethodCallCount [map=" + map + ", countPut=" + countPut + ", countPutAll=" + countPutAll
				+ ", countPutIfAbsent=" + countPutIfAbsent + ", getCountPut()=" + getCountPut() + ", getCountPutAll()="
				+ getCountPutAll() + ", getCountPutIfAbsent()=" + getCountPutIfAbsent() + ", size()=" + size()
				+ ", isEmpty()=" + isEmpty() + ", keySet()=" + keySet() + ", values()=" + values() + ", entrySet()="
				+ entrySet() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode() + ", toString()="
				+ super.toString() + "]";
	}
